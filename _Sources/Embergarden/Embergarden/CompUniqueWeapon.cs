...
{
    [DefOf]
    public static class Cinder_RulePackDefOf
    {
        public static RulePackDef Cinder_NamerUniqueWeapon;
    }
    ...
    public class CompUniqueWeapon : ThingComp
    {
        ...
        public override void PostPostMake()
        {
            ...
            request.Includes.Add(Cinder_RulePackDefOf.Cinder_NamerUniqueWeapon);
